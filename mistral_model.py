...
class MistralAttention(nn.Module):
    ...
    def __init__(self, config: MistralConfig, layer_idx: int):
        ...
        if self.layer_idx % self.structure_fq == 0:
            self.structure_q_proj = nn.Linear(config.hidden_size, config.num_attention_heads * self.head_NBFdim, bias=False)
    ...
    def eager_attention_forward(self,
        ...
        if self.layer_idx % self.structure_fq == 0:
            ...
            structure_value_states = structure_value_states.view(bsz, structure_value_states.size(1),
                                                                 self.config.num_attention_heads, self.head_dim).transpose(1,
                                                                                                                    2)
